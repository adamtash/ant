...
export function createEventPublishers(stream: EventStream) {
  return {
    ...
    taskCreated: stream.createPublisher("task_created"),
    taskStarted: stream.createPublisher("task_started"),
    taskCompleted: stream.createPublisher("task_completed"),
    taskStatusChanged: stream.createPublisher("task_status_changed"),
    taskPhaseChanged: stream.createPublisher("task_phase_changed"),
    taskProgressUpdated: stream.createPublisher("task_progress_updated"),
    taskTimeoutWarning: stream.createPublisher("task_timeout_warning"),
    taskTimeout: stream.createPublisher("task_timeout"),
    taskRetryScheduled: stream.createPublisher("task_retry_scheduled"),
